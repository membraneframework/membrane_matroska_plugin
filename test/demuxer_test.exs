  ...
  defmodule TestPipeline do
    ...
    def handle_notification({:new_channel, {track_id, details}}, :demuxer, _context, state) do
      case details.codec do
        :opus ->
          children = %{
            #! the opus stream generated by the demuxer is playable but the opus file created by the sink is not because it is not ogg encapsulated
        ...
        :vp8 ->
          children = %{
            {:serializer, track_id} => %Membrane.Element.IVF.Serializer{
              width: details.width, # TODO maybe change IVF.Serializer so that these values can be passed via caps
