  ...
  defp deps do
    [
      ...
      {:membrane_file_plugin,
       ...
       override: true},
      {:membrane_flv_plugin,
       github: "membraneframework/membrane_flv_plugin", branch: "bugfix/timestamps_to_nanoseconds"},
      # {:membrane_flv_plugin, path: "~/dev/membrane_flv_plugin"},
      # {:membrane_flv_plugin, "~> 0.1.0"},
      {:membrane_ogg_plugin,
       github: "membraneframework/membrane_ogg_plugin", only: :test, runtime: false},
      # {:membrane_h264_ffmpeg_plugin, "~> 0.19.0"},
      {:membrane_h264_ffmpeg_plugin, "~> 0.20.0"},
      # {:membrane_h264_ffmpeg_plugin, path: "~/dev/membrane_h264_ffmpeg_plugin"},
