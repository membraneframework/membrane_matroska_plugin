defmodule Membrane.WebM.Plugin.Mixfile do
  ...
  defp deps do
    [
      ...
      #  runtime: false},
       {:membrane_ivf_plugin,
        path: "/Users/maksstachowiak/Projects/membrane_ivf_plugin",
        only: :test,
        runtime: false},
      {:membrane_vp8_format, github: "membraneframework/membrane_vp8_format", branch: "add-stream-params"},
      {:membrane_vp9_format, github: "membraneframework/membrane_vp9_format", branch: "add-stream-params"},
